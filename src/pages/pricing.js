          ...
          <div id="doc">
            ...
            <section>
              ...
              <ul>
                ...
                <ul class="second">
                  <li><a href={matchReport} target="_blank" rel="noopener noreferrer">A full DataVolley match report (*)</a></li>
                  <li><a href={attackDirectionSR} target="_blank" rel="noopener noreferrer">Attacks after receive by rotation report (*)</a></li>
                  <li><a href={attackDirectionTrans} target="_blank" rel="noopener noreferrer">Attacks during transition by rotation report (*)</a></li>
                  <li><a href={stats} target="_blank" rel="noopener noreferrer">Passing Stats report (*)</a></li>
                  <li><a href={distribution} target="_blank" rel="noopener noreferrer">Setter distribution report (*)</a></li>
                </ul>
              </ul>
